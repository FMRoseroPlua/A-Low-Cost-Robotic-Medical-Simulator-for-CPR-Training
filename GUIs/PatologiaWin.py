...
class Ui_Patologia(object):
    def setupUi(self, Patologia):
        ...
        self.graphicsView = PlotWidget(Patologia)
        self.graphicsView.setGeometry(QtCore.QRect(300, 50, 451, 321))
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(50, 220, 75, 23))
    ...
    def retranslateUi(self, Patologia):
        ...
        self.pushButton_4.setText(_translate("Patologia", "PushButton", None))
